...
<html lang="en">
	...
	<body style="background-color: #f5f7b9;">
		...
		<div class="text-center">
  			...
  			<form method="POST">
  				@csrf
	  			<br><label for="stype"><b>Select the type of Admin Support work you need</b></label></br>
	  			<select name="s1" id="s1">
	  				<option value="Virtual/Administrative Assistance">Virtual/Administrative Assistance</option>
