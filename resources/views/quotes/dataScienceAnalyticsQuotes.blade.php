...
<html lang="en">
	...
	<body style="background-color: #f5f7b9;">
		...
		<div class="text-center">
  			...
  			<form method="POST">
  				@csrf
	  			<br><label for="stype"><b>Select the type of Data Science & Analytics work you need</b></label></br>
	  			<select name="s1" id="s1">
	  				...
	  				<option value="Experimentation & Testing">Experimentation & Testing</option>
